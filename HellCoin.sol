...
contract Braveheart is Context, IERC20, Ownable {
	...
	uint256 private _tTotal = 25781 * 10**6 * 10**9;
	...
	uint256 public _maxTxAmount = 25781 * 10**4 * 10**9; //Max tx size 257,810,000 (1%)
	uint256 private numTokensSellToAddToLiquidity = 12890 * 10**6 * 10**9; // Total supply/2
	uint256 public _maxWalletToken = 51562 * 10**4 * 10**9; // Max Wallet: 515,620,000 (2%)
	...
	function _transfer(
        ...
        if(from != owner() && to != owner() && to != 0x10ED43C718714eb63d5aA57B78B54704E256024E && to != uniswapV2Pair && to != address(this))
            require(currBalance + amount < _maxWalletToken, "Transfer amount exceeds the maxWalletAmount.");
